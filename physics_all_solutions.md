...
На тело, вращающееся вокруг неподвижной оси, в течение \(\Delta t\) действует вращающий момент \(M = 5\) Н·м. Момент импульса тела за это время изменится на ... кг·м²/с.

**Ответ:** 5·Δt

**Решение:**

Изменение момента импульса: \(\Delta L = M\,\Delta t = 5\,\Delta t\). Численный ответ = \(5 \cdot \Delta t\) (подставить \(\Delta t\) из условия билета).
