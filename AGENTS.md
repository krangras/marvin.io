...
### Что сделано
- **Шрифты**: `Caveat` (handwriting) и `Patrick Hand` заменены на `Segoe UI` во всех элементах (условия задач, темы, ответы) — стало читаемо
- **МКТ**: полностью переписан раздел (23 задач) под docx-структуру — газовые законы (1–5), МКТ уравнение (6–12), распределение Максвелла (13–23); изображения переизвлечены и корректно названы
- **Термодинамика**: обновлены ответы и решения для задач 6, 10–15 по решениям пользователя; изображения извлечены
- **Электростатика**: добавлен раздел (16 задач)
- **Постоянный ток**: добавлен раздел (10 задач, 3 изображения)
- **Магнетизм**: добавлен раздел (19 задач, 7 изображений)
- **Электромагнитная индукция**: добавлен раздел (18 задач, 11 изображений)
